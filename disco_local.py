...
clip_models = []
if ViTB32: clip_models.append(clip.load('ViT-B/32', jit=False, download_root='/mnt/clip_models')[0].eval().requires_grad_(False).to(device))
if ViTB16: clip_models.append(clip.load('ViT-B/16', jit=False, download_root='/mnt/clip_models')[0].eval().requires_grad_(False).to(device))
if ViTL14: clip_models.append(clip.load('ViT-L/14', jit=False, download_root='/mnt/clip_models')[0].eval().requires_grad_(False).to(device))
if ViTL14_336px: clip_models.append(clip.load('ViT-L/14@336px', jit=False, download_root='/mnt/clip_models')[0].eval().requires_grad_(False).to(device))
if RN50: clip_models.append(clip.load('RN50', jit=False, download_root='/mnt/clip_models')[0].eval().requires_grad_(False).to(device))
if RN50x4: clip_models.append(clip.load('RN50x4', jit=False, download_root='/mnt/clip_models')[0].eval().requires_grad_(False).to(device))
if RN50x16: clip_models.append(clip.load('RN50x16', jit=False,download_root='/mnt/clip_models')[0].eval().requires_grad_(False).to(device))
if RN50x64: clip_models.append(clip.load('RN50x64', jit=False,download_root='/mnt/clip_models')[0].eval().requires_grad_(False).to(device))
if RN101: clip_models.append(clip.load('RN101', jit=False,download_root='/mnt/clip_models')[0].eval().requires_grad_(False).to(device))
